...
//	private boolean textAllCaps = true;
	...
	public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
		...
		//indicatorPadding = a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_pstsUnderlineHeight, indicatorPadding);
...
//	}
	...
	//设置底部线左右padding
	public void setIndicatorPaddingLeftRight(int indicatorPaddingPx) {
